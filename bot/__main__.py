...
PM_START_TEXT = """
*Hello* *{}*
*My name is* *{}*\n\n`ഞാൻ ഒരു ആടാർ ഫിൽറ്റർ ബോട്ട് ആണ് എൻറെ വിധി എൻറെ അഡ്മിന്റെ തീരുമാനങ്ങളാണ്!`
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="⚙️Help",callback_data="help_back"),InlineKeyboardButton(text="Master😴",url="https://t.me/Ameen_Ameen_12")]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⚙️Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="😴Contact Creator",url="https://t.me/Ameen_Ameen_12")]]))
        return
